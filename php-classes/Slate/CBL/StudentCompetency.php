...
class StudentCompetency extends \ActiveRecord
{
    ...
    public static $getDemonstrationDataCustom;
    ...
    public function getDemonstrationData()
    {
        if ($this->demonstrationData === null) {
            ...
            try {
                ...
                if (count($skillIds)) {
                    if ($this->$getDemonstrationDataCustom){
                        $this->demonstrationData = $getDemonstrationDataCustom($this, [
                    ...
                    foreach ($this->demonstrationData as &$demonstrationSkills) {
                        foreach ($demonstrationSkills as &$demonstrationSkill) {
                            ...
                            $demonstrationSkill['LevelShortName'] = intval($demonstrationSkill['DemonstratedLevel']);
                            $demonstrationSkill['LevelName'] = intval($demonstrationSkill['DemonstratedLevel']);                            
